...
@Repository
public interface VerificadorRepository extends JpaRepository<TramitePosesion, Long> {
    @Query(value = "SELECT DISTINCT\n" +
            ...
            "WHERE \n" +
            "    (tp.idtipoestadotramiteposesion = :idTipoEstadoTramitePosesion OR :idTipoEstadoTramitePosesion IS NULL) \n" +
            ...
            "    AND (tpet.NOMBRE = :estadoTramite OR :estadoTramite IS NULL) \n" +
